...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Bond phat rahi bhae🤒",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~8cc72c3a55d95f056a1f2b197574b0c6:5a30664d6d55506f4b79633d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "WAQAS😈",
    BOT_NAME: process.env.BOT_NAME || 'WAQAS😈',
